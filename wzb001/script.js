...
const RAW_DATA = [{
    ...
    id: 15, title: "程序开发", icon: "fa-code", websites: [
        ...
        { name: "图片轮播", url: "https://wzb13014.github.io/wzb/tool175", desc: "工具" },      
...
function syncThemeColor(theme) {
    ...
    themeColorMeta.setAttribute('content', theme === 'dark' ? '#05070e' : '#eef2fa');
}
...
function applySettings() {
    ...
    // 【修复】主题类挂到 <html> 上：玻璃材质的 CSS 变量定义在 .dark-mode 选择器中，
    // 挂在根元素才能被整棵文档继承，<body> 自身的底色也才会跟着变。
    // （原实现只在 body 上打类，而背景规则写的是 `.dark-mode body`，选择器永远命中不了，
    //   导致暗色模式下页面底色始终是浅色渐变。）
    document.documentElement.classList.toggle('dark-mode', s.theme === 'dark');
    document.body.classList.toggle('dark-mode', s.theme === 'dark');
    syncThemeColor(s.theme);
...
function bindEvents() {
    ...
    // 设置下拉：仅看收藏 / 密度 / 网站图标 / 视图切换 / 快捷键 / 网址征集 / 恢复默认
    tap(settingsBtn, () => {
        // 关闭其他可能打开的下拉
